...
const SetTimeWindow = () => {
  const { showSetTimerWindow, setShowSetTimerWindow, currentChat } = useMessenger();
  const { user } = useUser()
  ...
  }, [showSetTimerWindow, bgApi, contentApi]);
  ...
  if (!showSetTimerWindow) return null;
