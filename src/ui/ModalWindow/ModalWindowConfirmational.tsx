...
const ModalWindowConfirmation = ({isVisible, toggleVisible, header="Header", children}:{isVisible:boolean, toggleVisible: () => void, text: string, header: string, children: any}) => {
    ...
    return (
        <animated.div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex justify-center items-center z-[1000]"
                      style={{ ...springs }}
                      onClick={onClose}
        >
